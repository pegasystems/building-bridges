...
global.fetch = jest.fn(() =>
    Promise.resolve({
        json: () => Promise.resolve({questions: [
                {_id: '1234', content: 'Question 1', upvotes: 1, downvotes: 0, isAuthor: true, isAnonymous: true},
                {_id: '1235', content: 'Question 2', upvotes: 0, downvotes: 1, isAuthor: false, isAnonymous: true}
